...
export function ChatMessage({ message }: ChatMessageProps) {
  ...
  if (isUser) {
    return (
      <div className="flex justify-end">
        <div 
          className="max-w-[85%] px-4 py-3 rounded-2xl border border-white/10"
  ...
  return (
    <div className="flex justify-start">
      <div 
        className="max-w-[95%] rounded-2xl border border-white/10 overflow-hidden"
      ...
      >
        ...
        <div className="px-4 pb-3 flex items-center gap-2">
          <button 
            className="w-8 h-8 rounded-lg border border-white/10 flex items-center justify-center text-white/40 hover:text-white/60 transition-colors"
