...
function getGreeting(logs: CoreFiveLog[], coverage: number): string {
  ...
  if (dow === 0 || dow === 6) {
    if (coverage >= 3) return `${coverage}/5 pillars hit.\nGood weekend to close the gaps.`;
...
// ============================================================================
// Smart Prompt Generation (with pillar + icon metadata)
// ============================================================================
...
// ============================================================================
// Pillar Ring (48px, tappable, with label)
// ============================================================================
...
function PillarRing({
  ...
  const label = config.name.length > 5 ? config.name.slice(0, 4) : config.name;
