                  ...
                  <div className="relative">
                    ...
                    {selectedEntryId === entry.id && (
                      <>
                        ...
                        />
                        <div 
                          className="absolute right-0 top-full mt-1 z-20 py-1 rounded-lg shadow-lg min-w-[120px] overflow-hidden"
                        ...
                        >
                          <button
                            ...
                            className="w-full px-4 py-2.5 text-left text-sm text-foreground/80 hover:bg-white/10 transition-colors flex items-center gap-2"
                          >
                          ...
                          <button
                            ...
                            className="w-full px-4 py-2.5 text-left text-sm text-red-400/90 hover:bg-white/10 transition-colors flex items-center gap-2 disabled:opacity-50"
                          >
                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
